...
import { PermanentDrawer, DrawerContent, DrawerToolbarSpacer } from 'material-toolbox/drawer';
...
export default class PermanentDrawerAboveApp extends React.Component<
  {},
  State,
> {
  state = {
        ...
        <Toolbar>
          <ToolbarRow>
            <ToolbarSection align="start">
              ...
              <ToolbarTitle label="Permanent Drawer Above Toolbar" />
            </ToolbarSection>
          </ToolbarRow>
        </Toolbar>
        <ToolbarFixedAdjust>
